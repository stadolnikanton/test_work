...
class TestAccessRules:
    ...
    def setup_business_objects(self):
        users_obj = BusinessObject.objects.create(
            name="Пользователи", code="users", description="Управление пользователями"
        )
    ...
    def test_admin_has_all_permissions(
        self, auth_client, admin_user, setup_roles, setup_business_objects
    ):
    ...
    def test_user_limited_permissions(
        self, auth_client, user, setup_roles, setup_business_objects
    ):
